class _Config:
    def __init__(self):
        ...
        self.default_columns = list(self.days.values())+list(self.months.values())+['2011','2012','2013']+ ['TIME', 'JOUR','NUIT']+ ['CSPL_RECEIVED_CALLS']
        self.sub_columns = list(self.days.values()) + list(self.months.values())+['2011','2012','2013'] + ['TIME', 'JOUR','NUIT']
        self.test_columns = list(self.days.values())+list(self.months.values())+['2011','2012','2013']+ ['JOUR','NUIT']
CONFIG = _Config()
